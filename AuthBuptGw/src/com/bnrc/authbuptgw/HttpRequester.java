...
public class HttpRequester {
	...
	private HttpResponser makeContent(String urlString, HttpURLConnection urlConnection) throws IOException {
		...
		//生成头部字段内容
		Map<String, List<String> > headsMap = urlConnection.getHeaderFields();
		Set<String> keys = headsMap.keySet();
		Iterator<String> it = keys.iterator();
		while (it.hasNext()) {
			String name = (String) it.next();
			String val  = urlConnection.getHeaderField(name);
			httpResponser.headFieldsMap.put(name, val);
		}
